...
public class IncidentView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            Call<List<ReportIncident>> call = apiInterface.getIncidents(Integer.parseInt(id.toString()),"Open");
            ...
            Toast.makeText(this,"Something went wrong getting Reported Incidents information from the server.",Toast.LENGTH_LONG).show();
        }
    }
